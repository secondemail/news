                            ...
                            <Offcanvas.Header closeButton>
                                {
                                    localStorage.getItem("skylineLoginUser") !== null ?
                                        JSON.parse(localStorage.getItem("skylineLoginUser")).role === "admin" ?
                                            (
                                                <Link onClick={handleClose} style={{marginRight:"0px"}} to="/admin/dashboard">
                                                    <img 
                                                        src={logo}
                                                        width="200"
                                                        alt=""
                                            ...
                                            (
                                                <Link onClick={handleClose} style={{marginRight:"0px"}} to="/">
                                                    <img 
                                                        src={logo}
                                                        width="200"
                                                        alt=""
                                            ...
                                            <Offcanvas.Body>
                                                <Accordion defaultActiveKey="0">
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        <Accordion.Body>
                                                            <NavLink onClick={handleClose} to={`/admin/addCategory`} className='my-2'>
                                                                <div className='my-2'>
                                                                    <ArrowCircleLeftIcon/>
                                                                    أضف تصنيف جديد
                                                                </div>
                                                            ...
                                                            <Divider/>
                                                            <NavLink onClick={handleClose} to={`/admin/addSubCategory`} className='my-2'>
                                                                <div className='my-2'>
                                                                    <ArrowCircleLeftIcon/>
                                                                    أضف تصنيف فرعي جديد
                                                                </div>
                                                            ...
                                                            <Divider/>
                                                            <NavLink onClick={handleClose} to={`/admin/addNews`} className='my-2'>
                                                                <div className='my-2'>
                                                                    <ArrowCircleLeftIcon/>
                                                                    أضف مقال جديد
                                                                </div>
                                                                                    ...
                                                                                    <Accordion.Body>
                                                                                        {
                                                                                            ...
                                                                                            subCatData.filter(data => data.catId === cat.id).map((subCat, index2) =>                                                                                 (
                                                                                                    <div key={index2}>
                                                                                                        <NavLink onClick={handleClose} to={`/category/${cat.id}/subcategory/${subCat.id}`} className='my-2'>
                                                                                                            {({ isActive }) => (
                                                                                                                isActive? 
                                                                                                                (
                                                                                                                    <div className='my-2'>
                                        ...
                                        (
                                            <Offcanvas.Body>
                                                <Accordion defaultActiveKey="0">
                                                    ...
                                                    <div className='text-center my-4'>
                                                        <Link onClick={handleClose} className='btn btn-outline-dark' to="/admin/login">
                                                            تسجيل الدخول
                                                        </Link>
                                                    </div>
                                                </Accordion>
